...
public class OtpConfirmProcess {

    private OnLoginAction onLoginAction;
    private static final String URL_OTP = Utils.SERVER + "userconfirm";
    private List<UserModel> userModelList;

    public OtpConfirmProcess(OnLoginAction loginAction) {
        this.onLoginAction = loginAction;
    }


    /*call start*/
    public void startprocess(String userid, String otp, Context context) {
        ...
        netUtils.postRequest(URL_OTP, data);
    }
}
