...
public class EditProfileProcess {

    private OnLoginAction onLoginAction;
    private static final String URL_EDIT = Utils.SERVER + "editprofile";
    private List<UserModel> userModelList;

    public EditProfileProcess(OnLoginAction loginAction) {
        this.onLoginAction = loginAction;
    }


    /*call start*/
    public void startprocess(String username, int userid, String userphone, String useraddress,Context context) {
        ...
        data.set("phone_no", userphone);
        data.set("user_address", useraddress);

        netUtils.postRequest(URL_EDIT, data);
    }
}
