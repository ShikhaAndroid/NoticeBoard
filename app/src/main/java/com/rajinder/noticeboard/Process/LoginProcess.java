...
public class LoginProcess {
    ...
    private static final String URL_SIGN_IN = Utils.SERVER + "login";
    private static final String URL_SOCIAL_LOGIN = Utils.SERVER + "sociallogin";
    private List<UserModel> userModelList;

    public LoginProcess(OnLoginAction loginAction) {
        this.onLoginAction = loginAction;
    }

    /*call start*/
    public void startprocess(Context context, String hex_data, String iv, String type) {
...
//        data.set("auth_for_post", "pkregister");
        ...
        if (type.equals("social"))
            netUtils.postRequest(URL_SOCIAL_LOGIN, data);
        else
            netUtils.postRequest(URL_SIGN_IN, data);
