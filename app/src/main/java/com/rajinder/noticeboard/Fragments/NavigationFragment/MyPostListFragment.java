...
public class MyPostListFragment extends BaseFragment implements OnPostListAction {
    ...
    private void Apicall(String _id) {
        ...
        postListProcess.startprocess(_id, _id, getActivity(),"userid", MyActivity.lng, MyActivity.lat);
    }
