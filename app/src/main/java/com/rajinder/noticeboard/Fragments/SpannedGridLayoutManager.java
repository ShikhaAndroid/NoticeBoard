...
public class SpannedGridLayoutManager extends RecyclerView.LayoutManager {
    ...
    SpannedGridInterface spannedGridInterface;
    ...
    public SpannedGridLayoutManager(GridSpanLookup spanLookup, int columns, float cellAspectRatio, SpannedGridInterface spannedGridInterface) {
        this.spanLookup = spanLookup;
        this.columns = columns;
        this.cellAspectRatio = cellAspectRatio;
        this.spannedGridInterface = spannedGridInterface;
        setAutoMeasureEnabled(true);
    }
    ...
    private void calculateWindowSize() {
        ...
        spannedGridInterface.onCalculateWindowSize(cellHeight,cellWidth);
    }
