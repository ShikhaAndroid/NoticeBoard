...
import com.rajinder.noticeboard.databinding.ViewItemRowPostBinding;
...
public class PostItemViewHolder extends RecyclerView.ViewHolder {
    ...
    private ViewItemRowPostBinding mBinding;
    private static Context mContext;

    public PostItemViewHolder(ViewItemRowPostBinding mBinding) {
        super(mBinding.getRoot());
        this.mBinding = mBinding;
    }

    public static PostItemViewHolder getHolderInstance(ViewGroup parent) {
        mContext = parent.getContext();
        ViewItemRowPostBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.view_item_row_post, parent, false);
    ...
    public void bind(final DemoModel obj, final int position) {
        ...
        mBinding.cateDis.setText(obj.getCate_disc());
        mBinding.catName.setText(obj.getCate_name());
        mBinding.catKm.setText(obj.getCate_distance());

        //   mBinding.setVariable(BR.category, obj);

        mBinding.txtCenter.setTextColor(color);
